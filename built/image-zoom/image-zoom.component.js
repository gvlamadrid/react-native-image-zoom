...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.heightDevice = react_native_1.Dimensions.get('window').height;
        _this.marginImage = 0;
        _this.opacity = 0;
        _this.opacityPosition = 0;
        _this.animationBackground = new react_native_1.Animated.Value(0);
        ...
        _this.panResponderReleaseResolve = function () {
            ...
            if (_this.props.enableSwipeDown && _this.props.swipeDownThreshold) {
                ...
                react_native_1.Animated.spring(_this.animatedPositionX, { toValue: 0 }).start();
                react_native_1.Animated.spring(_this.animationBackground, { toValue: 0.0 }).start();
            }
                ...
                if (evt.nativeEvent.changedTouches.length <= 1) {
                    ...
                    if (_this.props.panToMove) {
                        ...
                        if (_this.props.imageHeight * _this.scale > _this.props.cropHeight) {
                            ...
                            if ((_this.props.enableSwipeDown || _this.props.enableSwipeUp) && !_this.isHorizontalWrap) {
                                // 图片高度小于盒子高度，只能向下拖拽，而且一定是 swipeDown 动作
                                _this.swipeDownOffset += diffY;
                                _this.marginImage = (_this.heightDevice - _this.props.imageHeight) / 2;
                                // 只要滑动溢出量不小于 0，就可以拖动
                                if (_this.swipeDownOffset != 0) {
                                    ...
                                    if (_this.opacityPosition >= 1) {
                                        ...
                                        react_native_1.Animated.timing(_this.animationBackground, {
                                            toValue: _this.opacity / 100,
                                            duration: 100
                                        }).start();
                                    }
                                    _this.animatedPositionY.setValue(_this.positionY);
    ...
    ImageViewer.prototype.render = function () {
        ...
        var BackgroundColorConfig = this.animationBackground.interpolate({
        ...
        return (<react_native_1.Animated.View style={__assign({}, image_zoom_style_1.default.container, parentStyles, { backgroundColor: BackgroundColorConfig, width: this.props.cropWidth, height: this.props.cropHeight })} {...this.imagePanResponder.panHandlers}>
